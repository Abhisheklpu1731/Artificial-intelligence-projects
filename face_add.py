...
ratan_tata_encoding= face_recognition.face_encodings(jobs_image)[0]

tesla_image= face_recognition.load_image_file("tesla.jpg")
tesla_encoding= face_recognition.face_encodings(jobs_image)[0]

known_face_encoding=[
    jobs_encoding,
    ratan_tata_encoding,
    tesla_encoding]
known_face_names=["jobs","ratan tata","tesla"]
